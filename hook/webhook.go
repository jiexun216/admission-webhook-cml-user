...
const (
	...
	admissionWebhookAnnotationMutateKey   = "admission-webhook-cml-user.datacreating.com/mutate"
	
	// mark the object has already mutated by  webhookserver
	// if this' value is "mutated", then do not continue mutate
	admissionWebhookAnnotationStatusKey   = "admission-webhook-cml-user.datacreating.com/status"

	// admissionWebhookAnnotationStatusKey's value
	admissionWebhookAnnotationStatusKeyValue = "mutated"

	// add the object labels
	nameLabel      = "app.kubernetes.io/cml-user"
	instanceLabel  = "app.kubernetes.io/cml-user/instance"
